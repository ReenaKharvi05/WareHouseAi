...
from ..models import Questions, Warehouses
...
def create_question(payload: QuestionRead, db: Session = Depends(get_db)):
...
def update_question(qid: int, payload: QuestionRead, db: Session = Depends(get_db)):
